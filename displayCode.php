...
if(isset($_POST['subcodeID']))
{
    ...
    $_SESSION['subcodeID']=$c;
  // echo $_SESSION['subcodeID'];
   echo $c;
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div class="displayrecord">
        ...
        include('connection.php');
        $id = $_POST['q'];
        $sql = "SELECT * FROM CODEFILE WHERE CODEID LIKE '%" . $id . "%' ";
                ...
                <tr>
                  ...
                  <body>
                    ...
                    <div>
                      ...
                      <td> <a href="displayIndex1.php"><input type="submit" name="codeID[]" id="codeID" value="<?php echo $row['CODEID']; ?>"> </td>
                      <td> <?php echo $row['CODEDESC']; ?> </td>
                     <?php// var_dump($row)?>
                    </div>
                    </form>
                  </body>
