  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div class="displayrecord">
        ...
        $sql = "SELECT * FROM SUBCODE WHERE SUBCODEID LIKE '%".$b."%' ";
              ...
              <tbody align="center">
                ...
                <tr>
                  ...
                  <body>
                      ...
                      <form action="document1.php" method="POST">
                    <div>

                      <td style="text-align: center;">
                        <h8 > </h8>
                      </td>
                      <td> <a href="document1.php"><input type="submit" name="subcodeID[]" id="subcodeID" value="<?php echo $row['SUBCODEID']; ?>"> </td>
                      <td> <?php echo $row['SUBCODEDESC']; ?> </td>
